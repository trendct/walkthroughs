---
title: "Quick tutorial on using Leaflet in R"
author: "Andrew Ba Tran"
date: "June 26, 2015"
output: html_document
---

This is an R Markdown document mean to accompany the TrendCT.org tutorial: [How to put dots on a Leaflet map with R](http://trendct.org/2015/06/26/tutorial-how-to-put-dots-on-a-leaflet-map-with-r/)

We used data from Dunkin' Donuts filtered by [Connecticut locations](https://github.com/trendct/walkthroughs/blob/master/0615-leaflet-r/ctlist.csv).
...
# Be sure to set R working directory to where these files are located
